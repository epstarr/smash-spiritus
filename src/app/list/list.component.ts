...
export class ListComponent implements OnInit {
  ...
  slot_SVG = "<svg style='float:right;' class='spirit-slot-svg' version='1.0' xmlns='http://www.w3.org/2000/svg' width='25' height='22' viewBox='0 0 50 45' stroke='#fff'><polygon class='hex' points='50,21.7 37.5,43.4 12.5,43.4 0,21.7 12.5,0 37.5,0'></polygon></svg>"
  slot_SVG2 = "<svg style='float:right;' class='spirit-slot-svg' version='1.0' xmlns='http://www.w3.org/2000/svg' width='25' height='22' viewBox='0 0 50 45' stroke='#fff'><polygon class='hex' points='50,21.7 37.5,43.4 12.5,43.4 0,21.7 12.5,0 37.5,0'></polygon></svg><svg style='float:right;' class='spirit-slot-svg' version='1.0' xmlns='http://www.w3.org/2000/svg' width='25' height='22' viewBox='0 0 50 45' stroke='#fff'><polygon class='hex' points='50,21.7 37.5,43.4 12.5,43.4 0,21.7 12.5,0 37.5,0'></polygon></svg>"
  slot_SVG3 = "<svg style='float:right;' class='spirit-slot-svg' version='1.0' xmlns='http://www.w3.org/2000/svg' width='25' height='22' viewBox='0 0 50 45' stroke='#fff'><polygon class='hex' points='50,21.7 37.5,43.4 12.5,43.4 0,21.7 12.5,0 37.5,0'></polygon></svg><svg style='float:right;' class='spirit-slot-svg' version='1.0' xmlns='http://www.w3.org/2000/svg' width='25' height='22' viewBox='0 0 50 45' stroke='#fff'><polygon class='hex' points='50,21.7 37.5,43.4 12.5,43.4 0,21.7 12.5,0 37.5,0'></polygon></svg><svg style='float:right;' class='spirit-slot-svg' version='1.0' xmlns='http://www.w3.org/2000/svg' width='25' height='22' viewBox='0 0 50 45' stroke='#fff'><polygon class='hex' points='50,21.7 37.5,43.4 12.5,43.4 0,21.7 12.5,0 37.5,0'></polygon></svg>"
  ngOnInit() {
